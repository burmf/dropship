            ...
            <div className="container relative z-10 px-6 text-center text-white">
                ...
                >
                    ...
                    <h1 className="text-5xl md:text-7xl lg:text-9xl font-bold tracking-tighter mb-8 leading-tight">
                        Our Hearts <br />
                        <span className="text-transparent bg-clip-text bg-gradient-to-r from-white via-amber-100 to-white/70">
                            Beat as One.
                        </span>
                    </h1>
                    <p className="max-w-xl mx-auto text-lg md:text-xl text-white/90 mb-10 leading-relaxed font-light">
                        Celebrate the unconditional love with our premium matching collections. Designed for comfort, styled for connection.
                    </p>
